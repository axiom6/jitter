...
(function() {
  ...
  Radar = (function() {
    ...
    function Radar(g, isRadar, width, height) {
      this.g = g;
      this.isRadar = isRadar != null ? isRadar : true;
      this.width = width != null ? width : 1200;
      this.height = height != null ? height : 800;
      this.doTechs = __bind(this.doTechs, this);
      this.doQuads = __bind(this.doQuads, this);
    ...
    Radar.prototype.grid = function(da, dr, ba, ea, br, er) {
      var ang, cos, r, sin, _i, _j, _k, _ref, _ref1, _ref2;
      if (ba == null) {
        ba = 0;
      }
      if (ea == null) {
      ...
      for (ang = _i = ba; da > 0 ? _i < ea : _i > ea; ang = _i += da) {
      ...
      for (r = _j = br; dr > 0 ? _j < er : _j > er; r = _j += dr) {
        this.circle(r);
      }
      for (r = _k = _ref = this.r08, _ref1 = this.r40, _ref2 = this.r08; _ref2 > 0 ? _k < _ref1 : _k > _ref1; r = _k += _ref2) {
        this.circle(r);
      }
    };
    ...
    Radar.prototype.quads = function(quadrants, r1, r2) {
      var ang, beg, cos, dif, i, n, name1, name2s, sin, _i, _j;
    ...
    Radar.prototype.pts = function(techs) {
      ...
      }).attr("r", 6).attr("fill", "orange").attr("stroke", "orange").attr("stroke-width", 1);
